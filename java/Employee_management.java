...
public class Employee_management {
    ...
    public static void main(String[] args) {
        ...
        Employee employee = new Employee("", 0, salary, salary);
    ...
    private static void extracted(Employee employee, double salary) {
        ((Employee_management) employee).setSalary(salary);
    }
}
